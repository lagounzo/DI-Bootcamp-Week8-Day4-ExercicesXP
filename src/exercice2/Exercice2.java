 ...
 * @Author : N'ZO LAGOU
 *
 * Exercice 2 : Opération INSERT

 * Dans cet exercice, vous allez créer des enregistrements dans notre table COMPANY créée dans l'exercice précédent à l'aide de PostgreSQL JDBC
 *
